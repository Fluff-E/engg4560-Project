...
module soc_system_mm_interconnect_0 (
		output wire [3:0]  eric_ip_0_aps_s0_paddr,                                           //                                           eric_ip_0_aps_s0.paddr
		output wire        eric_ip_0_aps_s0_psel,                                            //                                                           .psel
		output wire        eric_ip_0_aps_s0_penable,                                         //                                                           .penable
		output wire        eric_ip_0_aps_s0_pwrite,                                          //                                                           .pwrite
		output wire [31:0] eric_ip_0_aps_s0_pwdata,                                          //                                                           .pwdata
		input  wire [31:0] eric_ip_0_aps_s0_prdata,                                          //                                                           .prdata
		input  wire        eric_ip_0_aps_s0_pready,                                          //                                                           .pready
	...
	wire    [3:0] eric_ip_0_aps_s0_agent_altera_apb_master_paddr;                                     // eric_ip_0_aps_s0_agent:paddr -> eric_ip_0_aps_s0_translator:s0_paddr
	wire          eric_ip_0_aps_s0_agent_altera_apb_master_pready;                                    // eric_ip_0_aps_s0_translator:s0_pready -> eric_ip_0_aps_s0_agent:pready
	wire   [31:0] eric_ip_0_aps_s0_agent_altera_apb_master_prdata;                                    // eric_ip_0_aps_s0_translator:s0_prdata -> eric_ip_0_aps_s0_agent:prdata
	wire          eric_ip_0_aps_s0_agent_altera_apb_master_pslverr;                                   // eric_ip_0_aps_s0_translator:s0_pslverr -> eric_ip_0_aps_s0_agent:pslverr
	wire   [31:0] eric_ip_0_aps_s0_agent_altera_apb_master_pwdata;                                    // eric_ip_0_aps_s0_agent:pwdata -> eric_ip_0_aps_s0_translator:s0_pwdata
	wire          eric_ip_0_aps_s0_agent_altera_apb_master_penable;                                   // eric_ip_0_aps_s0_agent:penable -> eric_ip_0_aps_s0_translator:s0_penable
	wire          eric_ip_0_aps_s0_agent_altera_apb_master_psel;                                      // eric_ip_0_aps_s0_agent:psel -> eric_ip_0_aps_s0_translator:s0_psel
	wire          eric_ip_0_aps_s0_agent_altera_apb_master_pwrite;                                    // eric_ip_0_aps_s0_agent:pwrite -> eric_ip_0_aps_s0_translator:s0_pwrite
	wire          eric_ip_0_aps_s0_agent_altera_apb_master_paddr31;                                   // eric_ip_0_aps_s0_agent:paddr31 -> eric_ip_0_aps_s0_translator:s0_paddr31
	...
	wire          eric_ip_0_aps_s0_agent_rp_valid;                                                    // eric_ip_0_aps_s0_agent:rp_valid -> router_009:sink_valid
	wire  [128:0] eric_ip_0_aps_s0_agent_rp_data;                                                     // eric_ip_0_aps_s0_agent:rp_data -> router_009:sink_data
	wire          eric_ip_0_aps_s0_agent_rp_ready;                                                    // router_009:sink_ready -> eric_ip_0_aps_s0_agent:rp_ready
	wire          eric_ip_0_aps_s0_agent_rp_startofpacket;                                            // eric_ip_0_aps_s0_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          eric_ip_0_aps_s0_agent_rp_endofpacket;                                              // eric_ip_0_aps_s0_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> eric_ip_0_aps_s0_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> eric_ip_0_aps_s0_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                              // eric_ip_0_aps_s0_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> eric_ip_0_aps_s0_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> eric_ip_0_aps_s0_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> eric_ip_0_aps_s0_burst_adapter:sink0_endofpacket
	wire          eric_ip_0_aps_s0_burst_adapter_source0_valid;                                       // eric_ip_0_aps_s0_burst_adapter:source0_valid -> eric_ip_0_aps_s0_agent:cp_valid
	wire  [128:0] eric_ip_0_aps_s0_burst_adapter_source0_data;                                        // eric_ip_0_aps_s0_burst_adapter:source0_data -> eric_ip_0_aps_s0_agent:cp_data
	wire          eric_ip_0_aps_s0_burst_adapter_source0_ready;                                       // eric_ip_0_aps_s0_agent:cp_ready -> eric_ip_0_aps_s0_burst_adapter:source0_ready
	wire    [5:0] eric_ip_0_aps_s0_burst_adapter_source0_channel;                                     // eric_ip_0_aps_s0_burst_adapter:source0_channel -> eric_ip_0_aps_s0_agent:cp_channel
	wire          eric_ip_0_aps_s0_burst_adapter_source0_startofpacket;                               // eric_ip_0_aps_s0_burst_adapter:source0_startofpacket -> eric_ip_0_aps_s0_agent:cp_startofpacket
	wire          eric_ip_0_aps_s0_burst_adapter_source0_endofpacket;                                 // eric_ip_0_aps_s0_burst_adapter:source0_endofpacket -> eric_ip_0_aps_s0_agent:cp_endofpacket
	...
	altera_merlin_apb_translator #(
		...
		.USE_M0_PADDR31 (0),
		.USE_M0_PSLVERR (0)
	) eric_ip_0_aps_s0_translator (
		.s0_paddr   (eric_ip_0_aps_s0_agent_altera_apb_master_paddr),      //        s0.paddr
		.s0_psel    (eric_ip_0_aps_s0_agent_altera_apb_master_psel),       //          .psel
		.s0_penable (eric_ip_0_aps_s0_agent_altera_apb_master_penable),    //          .penable
		.s0_pwrite  (eric_ip_0_aps_s0_agent_altera_apb_master_pwrite),     //          .pwrite
		.s0_pwdata  (eric_ip_0_aps_s0_agent_altera_apb_master_pwdata),     //          .pwdata
		.s0_prdata  (eric_ip_0_aps_s0_agent_altera_apb_master_prdata),     //          .prdata
		.s0_pslverr (eric_ip_0_aps_s0_agent_altera_apb_master_pslverr),    //          .pslverr
		.s0_pready  (eric_ip_0_aps_s0_agent_altera_apb_master_pready),     //          .pready
		.s0_paddr31 (eric_ip_0_aps_s0_agent_altera_apb_master_paddr31),    //          .paddr31
		.clk        (clk_0_clk_clk),                                       //       clk.clk
		.reset      (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
		.m0_paddr   (eric_ip_0_aps_s0_paddr),                              //        m0.paddr
		.m0_psel    (eric_ip_0_aps_s0_psel),                               //          .psel
		.m0_penable (eric_ip_0_aps_s0_penable),                            //          .penable
		.m0_pwrite  (eric_ip_0_aps_s0_pwrite),                             //          .pwrite
		.m0_pwdata  (eric_ip_0_aps_s0_pwdata),                             //          .pwdata
		.m0_prdata  (eric_ip_0_aps_s0_prdata),                             //          .prdata
		.m0_pready  (eric_ip_0_aps_s0_pready),                             //          .pready
	...
	altera_merlin_apb_slave_agent #(
		...
		.ST_CHANNEL_W              (6),
		.ST_DATA_W                 (129)
	) eric_ip_0_aps_s0_agent (
		.paddr            (eric_ip_0_aps_s0_agent_altera_apb_master_paddr),       // altera_apb_master.paddr
		.psel             (eric_ip_0_aps_s0_agent_altera_apb_master_psel),        //                  .psel
		.penable          (eric_ip_0_aps_s0_agent_altera_apb_master_penable),     //                  .penable
		.pwrite           (eric_ip_0_aps_s0_agent_altera_apb_master_pwrite),      //                  .pwrite
		.pwdata           (eric_ip_0_aps_s0_agent_altera_apb_master_pwdata),      //                  .pwdata
		.pready           (eric_ip_0_aps_s0_agent_altera_apb_master_pready),      //                  .pready
		.prdata           (eric_ip_0_aps_s0_agent_altera_apb_master_prdata),      //                  .prdata
		.pslverr          (eric_ip_0_aps_s0_agent_altera_apb_master_pslverr),     //                  .pslverr
		.paddr31          (eric_ip_0_aps_s0_agent_altera_apb_master_paddr31),     //                  .paddr31
		.cp_valid         (eric_ip_0_aps_s0_burst_adapter_source0_valid),         //                cp.valid
		.cp_ready         (eric_ip_0_aps_s0_burst_adapter_source0_ready),         //                  .ready
		.cp_data          (eric_ip_0_aps_s0_burst_adapter_source0_data),          //                  .data
		.cp_channel       (eric_ip_0_aps_s0_burst_adapter_source0_channel),       //                  .channel
		.cp_startofpacket (eric_ip_0_aps_s0_burst_adapter_source0_startofpacket), //                  .startofpacket
		.cp_endofpacket   (eric_ip_0_aps_s0_burst_adapter_source0_endofpacket),   //                  .endofpacket
		.rp_valid         (eric_ip_0_aps_s0_agent_rp_valid),                      //                rp.valid
		.rp_ready         (eric_ip_0_aps_s0_agent_rp_ready),                      //                  .ready
		.rp_data          (eric_ip_0_aps_s0_agent_rp_data),                       //                  .data
		.rp_startofpacket (eric_ip_0_aps_s0_agent_rp_startofpacket),              //                  .startofpacket
		.rp_endofpacket   (eric_ip_0_aps_s0_agent_rp_endofpacket),                //                  .endofpacket
		.clk              (clk_0_clk_clk),                                        //               clk.clk
		.reset            (onchip_memory2_0_reset1_reset_bridge_in_reset_reset)   //         clk_reset.reset
	);
	...
	soc_system_mm_interconnect_0_router_009 router_009 (
		.sink_ready         (eric_ip_0_aps_s0_agent_rp_ready),                     //      sink.ready
		.sink_valid         (eric_ip_0_aps_s0_agent_rp_valid),                     //          .valid
		.sink_data          (eric_ip_0_aps_s0_agent_rp_data),                      //          .data
		.sink_startofpacket (eric_ip_0_aps_s0_agent_rp_startofpacket),             //          .startofpacket
		.sink_endofpacket   (eric_ip_0_aps_s0_agent_rp_endofpacket),               //          .endofpacket
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) eric_ip_0_aps_s0_burst_adapter (
		.clk                   (clk_0_clk_clk),                                        //       cr0.clk
		.reset                 (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),  // cr0_reset.reset
		...
		.source0_valid         (eric_ip_0_aps_s0_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (eric_ip_0_aps_s0_burst_adapter_source0_data),          //          .data
		.source0_channel       (eric_ip_0_aps_s0_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (eric_ip_0_aps_s0_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (eric_ip_0_aps_s0_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (eric_ip_0_aps_s0_burst_adapter_source0_ready)          //          .ready
	);
